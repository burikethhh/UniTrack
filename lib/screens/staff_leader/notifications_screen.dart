...
/// Screen to display notifications for student leaders and organization officers
class NotificationsScreen extends StatelessWidget {
  ...
  void _handleNotificationTap(
    ...
    if (!notification.isRead) {
      ...
      provider.markAsOpened(notification.id);
    } else if (notification.openedAt == null) {
      // If already read but not marked as opened (e.g., opened via push)
      provider.markAsOpened(notification.id);
    }
